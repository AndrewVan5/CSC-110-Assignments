...
class Date:
    ...
    def __repr__(self) -> str:
        ...
        'Date(12, 19, 2020)'
        """
        return f'Date({repr(self.__month)}, {repr(self.__day)}, {repr(self.__year)})'
    ...
    def is_after(self, other) -> bool:
        ...
        '''
        Returns whether or not 'self' date is after 'other' date as a bool.
        >>> test1 = Date(12, 19, 2020)
        >>> test2 = Date(12, 19, 2020)
        >>> Date.is_after(test1, test2)
        False
        >>> test1 = Date(12, 19, 2025)
        >>> test2 = Date(12, 19, 2020)
        >>> Date.is_after(test1, test2)
        True
        >>> test1 = Date(12, 19, 2020)
        >>> test2 = Date(11, 19, 2020)
        >>> Date.is_after(test1, test2)
        True
        >>> test1 = Date(12, 20, 2020)
        >>> test2 = Date(12, 19, 2020)
        >>> Date.is_after(test1, test2)
        True
        '''
